...
- Treat [PROJECT_SPEC.md](PROJECT_SPEC.md) as the product and acceptance authority, [ARCHITECTURE.md](ARCHITECTURE.md) as the current architecture proposal, and [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md) as the milestone and testing guide.
...
- Add or update behavior-focused tests with each implemented milestone. Prefer small, meaningful tests over snapshots.
